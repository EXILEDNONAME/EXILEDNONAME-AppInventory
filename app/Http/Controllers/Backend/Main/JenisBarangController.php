...
use App\Http\Requests\Backend\Main\JenisBarang\JenisBarangStoreRequest;
use App\Http\Requests\Backend\Main\JenisBarang\JenisBarangUpdateRequest;
...
class JenisBarangController extends Controller {
  ...
  **/
  ...
  public function store(JenisBarangStoreRequest $request) {
    $store = $request->all();
    $this->model::create($store);
    return redirect($this->url)->with('success', trans('default.notification.success.item-created'));
  }

  public function update(JenisBarangUpdateRequest $request, $id) {
    $data = $this->model::findOrFail($id);
    $update = $request->all();
    $data->update($update);
